...
| 0022 | Typed Content Library, Detail View & the Fold Gesture | **Proposed** 2026-06-19 (operator-gated) — 6 typed content types (one renderer → Now/Hub/Detail), container-transform fold gesture, first-class provenance+privacy, Dayfold M3 theme. D2 storage fork (unify vs extend) + brand name = operator calls. Fills the gap the designs mis-cite as "ADR 0015". Epic: `planning/content-detail-epic.md` |
