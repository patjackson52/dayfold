...
| 0025 | Auth Abuse-Control — Rate Limits & Lockout Constants | **Accepted** 2026-06-21 (operator-directed) — records the S3/S4 anti-abuse constants as a single source of truth: device authorize 10/600s·IP, token poll 600/600s·IP, owner-mint 20/600s, invite caps ≤10 active/≤20 pending, and the **invite-redeem lockout = 5 failed / 15 min → 15-min lock** (the `invitelocked` screen's cooldown). Composes with 0011/0021. *(0024 = settings privacy, lands via the settings PR.)* |
