...
import com.familyai.client.ALLOWED_SCHEMES
import com.familyai.client.schemeOf
 ...
 * body-link renderer via [com.familyai.client.ALLOWED_SCHEMES]) so the
...
fun cardActionUri(action: CardAction): String? = when (action) {
  ...
  is CardAction.Copy, is CardAction.Share, is CardAction.OpenDetail -> null
}
